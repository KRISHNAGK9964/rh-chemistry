    ...
    <div className="px-10 py-5">
      <div className="flex lg:flex-row flex-col items-center gap-10">
        <div className="flex flex-col h-full  gap-10 flex-1">
          ...
          <p className="ml-11 font-bold text-4xl text-[#911C82]">Why Choose NEET Test Series</p>
          ...
          <div className="flex items-center gap-4 ml-11">
            ...
            <p className="ml-1 text-gray-700">
              <span className="font-bold text-base">Daily NEET Paper Discussion:</span> Stay ahead of the curve with our
              daily NEET paper discussions. Engage in insightful conversations, dissecting each question to understand
              its nuances and underlying concepts.
            </p>
          </div>
          <div className="flex items-center gap-4 ml-11">
            <div className="rounded-full border bg-white p-4 shadow-md">
        ...
        <div className="p-4 flex-1 max-w-[380px] border border-gray-300 rounded-lg mr-12">
          ...
          <p className="text-gray-500 py-2">
            ...
            Ragvendra Hegde, this comprehensive test series is designed to equip you with the knowledge and skills
            needed to ace the NEET exam with confidence.
          </p>
          <div className="flex justify-between items-center">
            <button type="button" className="bg-[#334456] text-white p-2 px-5 rounded-lg">
              Attempt Free Test
            </button>
