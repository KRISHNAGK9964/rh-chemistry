          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-gray-700 text-justify">
                ...
                Breaking down barriers, we offer explanations in Kannada,
                ensuring that language is never a hindrance in your learning
                journey.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white p-2 py-4 rounded-md lg:p-4 lg:max-w-lg lg:border lg:bg-white lg:border-gray-300 lg:rounded-lg lg:mt-0 mt-4 mb-4">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <button
                type="button"
                className="bg-[#334456] text-white p-2 px-5 rounded-lg shadow-md"
              >
                Attempt Free Test
              </button>
            </a>
            <p className="text-sm text-gray-600">
              <span className="text-gray-800 font-bold">1000+</span> Enrolled
            </p>
          </div>
        </div>
      </div>
