      ...
      <div className="flex flex-col gap-10 p-10 bg-[rgb(250,250,251,1)]">
        <div>
          ...
          <p className="ml-11">
            ...
            dignissim lorem nibh et. Ac cum eget habitasse in feugiat senectus in.
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-10">
          ...
          <div className="flex w-3/4 lg:w-1/4 flex-col gap-3 border  border-gray-250  p-4 mr-12">
            ...
            <div>
              ...
              <p>
                02 Real Exam Simulation Experience the real NEET exam environment with our accurately simulated test
          ...
          <div className="flex w-3/4 lg:w-1/4 flex-col gap-3 border  border-gray-250  p-4">
            ...
            <div>
              ...
              <p>
                Expert Guidance Benefit from expert guidance and insights from experienced educators like R. H. Sir, who
