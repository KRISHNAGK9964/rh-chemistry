  ...
  return (
    <div className="bg-gray-100 p-4">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="mb-4">We are (“Company,” “we.” “us,” “our”).</p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          You can contact us by email at or by mail to these Legal Terms
        ...
        <p className="mb-4">Our intellectual property</p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          please address your request to: contact.scaleyou@gmail.com
        </p>
        <p className="mb-4">
          We don’t grant you the permission to post, reproduce, or publicly
        ...
        <p className="mb-4">
          We do not own any data, information, or material that you submit to
          the Services in the course of using the Services (“User Content”). You
          ...
          ownership or right to use of all submitted User Content.
        </p>
        <h2 className="text-xl font-semibold mb-2">SERVICES MANAGEMENT</h2>
        ...
        <p className="mb-4">
          ...
          of jurisdiction to resolve any dispute which may arise in connection
        ...
        <p className="mb-4">
          ...
          expressly provided below) informally for at least days before
        ...
        <p className="mb-4">
          ...
          LIABILITY OR RESPONSIBILITY FOR ANY ERRORS, MISTAKES, OR INACCURACIES
          OF CONTENT AND MATERIALS, PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY
          NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE
          SERVICES, ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
          AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
          STORED THEREIN, ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR
          FROM THE SERVICES, ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH
          MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY,
          AND/OR ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY
        ...
        <p className="mb-4">
          NOT WITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR
        ...
        <p className="mb-4">
          ...
          at{" "}
          <a href="mailto:contact.scaleyou@gmail.com" className="text-blue-500">
